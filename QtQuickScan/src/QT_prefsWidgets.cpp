/*
 *
 * ©K. D. Hedger. Wed  8 Apr 16:14:14 BST 2026 keithdhedger@gmail.com

 * This file (QT_prefsWidgets.cpp) is part of QtQuickScan.
...
void prefsWidgetsClass::setColourValue(QString label)
{
...
void prefsWidgetsClass::setCheckValue(QString label)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
...
void prefsWidgetsClass::setComboValue(QString label)
{
...
void prefsWidgetsClass::setFontValue(QString label)
{
...
void prefsWidgetsClass::setEditValue(QString label)
{
...
void prefsWidgetsClass::setSpinValue(QString label)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
...
void prefsWidgetsClass::setFileValue(QString label)
{
...
bool prefsWidgetsClass::getCheckPref(QString name)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	return(plugprefs.value(this->normalizeLabel(name)).toBool());
}

QString prefsWidgetsClass::getColourPref(QString name)
{
	return(this->getStringPref(name));
}

QString prefsWidgetsClass::getComboPref(QString name)
{
	return(this->getStringPref(name));
}

QString prefsWidgetsClass::getFontPref(QString name)
{
	return(this->getStringPref(name));
}

QString prefsWidgetsClass::getEditPref(QString name)
{
	return(this->getStringPref(name));
}

QString prefsWidgetsClass::getFilePref(QString name)
{
	return(this->getStringPref(name));
}

int prefsWidgetsClass::getSpinPref(QString name)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	return(plugprefs.value(this->normalizeLabel(name)).toInt());
}

QString prefsWidgetsClass::getStringPref(QString name)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	return(plugprefs.value(this->normalizeLabel(name)).toString());
}

void prefsWidgetsClass::setCheckPref(QString name,bool prefsval)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	plugprefs.setValue(this->normalizeLabel(name),prefsval);
}

void prefsWidgetsClass::setSpinPref(QString name,int prefsval)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	plugprefs.setValue(this->normalizeLabel(name),prefsval);
}

void prefsWidgetsClass::setColourPref(QString name,QString prefsval)
{
	this->setStringValue(name,prefsval);
}

void prefsWidgetsClass::setComboPref(QString name,QString prefsval)
{
	this->setStringValue(name,prefsval);
}

void prefsWidgetsClass::setFontPref(QString name,QString prefsval)
{
	this->setStringValue(name,prefsval);
}

void prefsWidgetsClass::setEditPref(QString name,QString prefsval)
{
	this->setStringValue(name,prefsval);
}

void prefsWidgetsClass::setFilePref(QString name,QString prefsval)
{
	this->setStringValue(name,prefsval);
}

void prefsWidgetsClass::setStringValue(QString name,QString prefsval)
{
	QSettings	plugprefs("KDHedger",this->thePrefsName);
	plugprefs.setValue(this->normalizeLabel(name),prefsval);
}
