/*
 *
 * ©K. D. Hedger. Wed  8 Apr 16:09:35 BST 2026 keithdhedger@gmail.com

 * This file (globals.h) is part of QtQuickScan.
...
enum fileEnums {PREVIEWITEM=1,SCANITEM,DIV1,OPENINGIMPITEM,PRINTITEM,DIV3,SAVEITEM,SAVEASJPGITEM,SAVEASPNGITEM,SAVEASPNMITEM,DIV2,PREFSITEM,DIV4,QUITITEM};
enum cropEnums{CROPTORECTITEM=0,CDIV1,OPENCROPPEDINGIMP,SAVECROPPEDASJPG,SAVECROPPEDASPNG,CDIV2,RESTORESCAN,HIDESELITEM,SHOWSELITEM,CLEARSELITEM};
